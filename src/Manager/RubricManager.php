...
class RubricManager extends ContainerAware
{
    ...
    protected function getRequestFromContainer()
    {
        ...
        } elseif ($this->container->hasScope('request') && $this->container->isScopeActive('request')) {
    ...
    public function getRubricFromRequest(Request $request = null)
    {
        ...
        if (!$request || !$request->get('_rubric')) {
            return null;
        }
    ...
    public function clearCache()
    {
        ...
        foreach ([/*'frontdev','frontprod',*/
                     'dev', 'prod', ] as $env) {
            foreach (['UrlGenerator', 'UrlMatcher'] as $file) {
